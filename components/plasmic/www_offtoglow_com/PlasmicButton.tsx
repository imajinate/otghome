...
import sty from "./PlasmicButton.module.css"; // plasmic-import: bUjxyyacyjDo/css
...
export type PlasmicButton__VariantsArgs = {
  ...
  color?: SingleChoiceArg<
    ...
    | "clearDash"
  >;
  selectRight?: SingleBooleanChoiceArg<"selectRight">;
  selectLeft?: SingleBooleanChoiceArg<"selectLeft">;
};
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.selectRight
      },
      {
        path: "selectLeft",
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.selectLeft
      }
    ],
    [$props, $ctx, $refs]
  );
    ...
    <button
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_clearDash_selectLeft]:
            hasVariant($state, "color", "clearDash") &&
            hasVariant($state, "selectLeft", "selectLeft"),
          ...
          [sty.rootselectLeft]: hasVariant($state, "selectLeft", "selectLeft"),
          [sty.rootselectRight]: hasVariant(
            $state,
            "selectRight",
            "selectRight"
          ),
          [sty.rootselectRight_shape_rounded]:
            hasVariant($state, "shape", "rounded") &&
            hasVariant($state, "selectRight", "selectRight"),
          ...
          [sty.rootshape_rounded_selectLeft]:
            hasVariant($state, "shape", "rounded") &&
            hasVariant($state, "selectLeft", "selectLeft"),
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__unmpb)}
                role={"img"}
              />
            ),
      ...
      >
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_clearDash]: hasVariant(
              $state,
              "color",
              "clearDash"
            ),
            ...
            [sty.slotTargetChildrenselectRight_shape_rounded]:
              hasVariant($state, "selectRight", "selectRight") &&
              hasVariant($state, "shape", "rounded"),
            ...
            [sty.slotTargetChildrenshape_rounded_selectLeft]:
              hasVariant($state, "shape", "rounded") &&
              hasVariant($state, "selectLeft", "selectLeft"),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__rRw4Q)}
                role={"img"}
              />
            ),

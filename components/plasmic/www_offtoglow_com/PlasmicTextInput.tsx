...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: EBZZZa8XvB9u/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__usvu9)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__rTfqg)}
              role={"img"}
            />
          ),

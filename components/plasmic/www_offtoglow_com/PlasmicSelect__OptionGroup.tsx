...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: pRC55VrHCPaa/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: f9wHHf_Tqns2/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__seQop)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__c4D)}
              />
            </React.Fragment>
          ),
          value: args.children
